        ...
        <div class="account-dialog">
          ...
          <div class="right">
            <div class="login__switches">
              <span class="login__switch" @click="loginClick(1)" :class="{'active':isActive===1}">登录账号</span>
              <span class="login__switch" @click="loginClick(2)" :class="{'active':isActive===2}">账号注册</span>
            </div>
            ...
            <div class="login__error"></div>
            <button type="button" class="ui-button login__button ui-button--colorful">登录</button>
